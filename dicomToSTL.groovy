/**
 * Script that converts DICOM image sequence stacks and saves them as a meshed STL file
 * 
 * @input A directory containing directories of DICOM sequences stacks
